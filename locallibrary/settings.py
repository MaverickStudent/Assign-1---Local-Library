...
"""
# Needed for code for To make the templates directory visible to the template loader
import os
...
SECRET_KEY = 'django-insecure-41$m*&g$22(86bs%y&gc&b-_p=sf)ufnvh+5+0)wmkiu1k9+w7'

# SECURITY WARNING: don't run with debug turned on in production!
# Modify the DEBUG = True and set it to False:
DEBUG = False

# Modify the ALLOWED_HOSTS line to add PythonAnywhere as an allowed host
...
# Redirect to home URL after user login (Default redirects to /accounts/profile/)
LOGIN_REDIRECT_URL = '/'
